...
nvinfer1::IPluginV2DynamicExt *ONNXScatterNDDynamic::clone() const noexcept {
...
// IPluginV2 Methods
const char *ONNXScatterNDDynamic::getPluginType() const noexcept { return PLUGIN_NAME; }

const char *ONNXScatterNDDynamic::getPluginVersion() const noexcept {
  return PLUGIN_VERSION;
}

int ONNXScatterNDDynamic::getNbOutputs() const noexcept { return 1; }

int ONNXScatterNDDynamic::initialize() noexcept { return 0; }

void ONNXScatterNDDynamic::terminate() noexcept {}

size_t ONNXScatterNDDynamic::getSerializationSize() const noexcept { return 0; }

void ONNXScatterNDDynamic::serialize(void *buffer) const noexcept {}

void ONNXScatterNDDynamic::destroy() noexcept {
  // This gets called when the network containing plugin is destroyed
  delete this;
}

void ONNXScatterNDDynamic::setPluginNamespace(const char *libNamespace) noexcept {
  mNamespace = libNamespace;
}

const char *ONNXScatterNDDynamic::getPluginNamespace() const noexcept {
...
const char *ONNXScatterNDDynamicCreator::getPluginName() const noexcept {
  return PLUGIN_NAME;
}

const char *ONNXScatterNDDynamicCreator::getPluginVersion() const noexcept {
  return PLUGIN_VERSION;
}

const nvinfer1::PluginFieldCollection *
ONNXScatterNDDynamicCreator::getFieldNames() noexcept {
  return &mFC;
}
...
void ONNXScatterNDDynamicCreator::setPluginNamespace(const char *libNamespace) noexcept {
  mNamespace = libNamespace;
}

const char *ONNXScatterNDDynamicCreator::getPluginNamespace() const noexcept {
  return mNamespace.c_str();
}
