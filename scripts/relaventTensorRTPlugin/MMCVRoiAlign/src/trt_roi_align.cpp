...
// IPluginV2 Methods
const char *RoIAlignPluginDynamic::getPluginType() const noexcept { return PLUGIN_NAME; }

const char *RoIAlignPluginDynamic::getPluginVersion() const noexcept {
  return PLUGIN_VERSION;
}

int RoIAlignPluginDynamic::getNbOutputs() const noexcept { return 1; }

int RoIAlignPluginDynamic::initialize() noexcept { return 0; }
...
RoIAlignPluginDynamicCreator::getFieldNames() noexcept {
  return &mFC;
}
